...
#'
#' This data contains the location and characteristics of the 328,030 nodes where the
#' RESOURCECODE hindcast data is available
#'
#' @format ## `rscd_field`
...
#' }
#' @source User Manual of the RESOURCECODE database <https://archimer.ifremer.fr/doc/00751/86306/>
"rscd_field"

#' Resourcecode SPEC grid
#'
#' This data contains the location and characteristics of the 24,276 nodes where the
#' full 2D spectral data is available in the RESOURCECODE hindcast data.
#'
...
#'
#' This data contains the coastline of the islands used to run the RESOURCECODE hindcast, as data separated from the mainland.
...
#'
# In terms of directional discretization, 36 directions were used (equivalent to a
