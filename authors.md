...
Source:
[`inst/CITATION`](https://github.com/Resourcecode-project/r-resourcecode/blob/v0.5.5/inst/CITATION)

Raillard N (????). *resourcecode: R package to access and process the
Resourcecode hindcast database of sea-states*. R package version 0.5.5,
